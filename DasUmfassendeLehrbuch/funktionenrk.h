...
/* Sortieren */
/** \brief Diese Funktion vertauscht die Reihenfolge von Zahlen in einem Array vom Anfang zum Ende und umgekehrt.
 *
 * \param int *array
 * \param int lenght
 * \param int durchlauf
...
void inhalt_array_umkehren(int *uebergabe_array, int lenght, int durchlauf)
{
  ...
  */
  ...
  {
    /* Array wurde einmal komplett durchlaufen und kann beendet werden. */
  }
}
